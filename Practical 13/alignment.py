...
def alignment(seq1,seq2,name1,name2):
    identical =0
    score=0
    ...
    with open(file) as infile:
        ...
        for line in infile:
            if line.startswith('>'):
                ...
                seq += line
    return seq
human_seq = open_file("human_DLX5.fasta")
mouse_seq = open_file("mouse_DLX5.fasta")
random_seq = open_file("random.fasta")
alignment(human_seq,mouse_seq,'human','mouse')
alignment(human_seq,random_seq,'human','random')
alignment(mouse_seq,random_seq,'mouse','random')